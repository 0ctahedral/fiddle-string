...
/*
  ...
  address, the hex value at that address and the decimal value at that address.
  Does not attempt to interpret the words as Garter values
 ...
 */
uint64_t *smarter_print_heap(uint64_t *from_start, uint64_t *from_end,
